...
import { PostListingModalProvider, usePostListingModal } from '../contexts/PostListingModalContext';
import { PostListingModalWrapper } from '../components/Buyer/PostListingModalWrapper/PostListingModalWrapper';

const Tab = createBottomTabNavigator<BuyerTabParamList>();

// Inner Navigator Component that can access the modal context
const BuyerTabNavigatorContent: React.FC = () => {
  ...
  return (
    <>
      ...
      {/* Modal that appears when triggered */}
      <PostListingModalWrapper />
    </>
  );
};

// Main Navigator wrapped with Provider
export const BuyerTabNavigator: React.FC = () => {
  return (
    <PostListingModalProvider>
      <BuyerTabNavigatorContent />
    </PostListingModalProvider>
  );
};
